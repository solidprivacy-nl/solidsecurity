# Mission R2 Workpackages

Machine-readable source of truth: `model/workpackages_r2.yaml`.

This file is intentionally an index, not a second specification.
...
| `R2-WP05` | Productize from observed friction | WP04 | E2/E3 progressing to E4 |
