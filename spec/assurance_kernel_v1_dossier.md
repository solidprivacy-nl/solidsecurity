...
- `REQ-ACCESS-LIFECYCLE`: `SRC-SYNTH-ACCESS -> REQ-ACCESS-LIFECYCLE -> SS-SUP-002 -> IMP-SUPPLIER -> EVID-GOV-REVIEW -> ASM-ACCESS-SUPPLIER -> REV-ACCESS-SUPPLIER -> DEC-ACCESS-SUPPLIER -> VERIFIED`
...
- `REQ-SUPPLIER-GOV`: `SRC-SYNTH-SUPPLIER -> REQ-SUPPLIER-GOV -> SS-SUP-002 -> IMP-SUPPLIER -> EVID-GOV-REVIEW,EVID-SUPPLIER-ATTESTATION -> ASM-SUPPLIER -> CONFLICT-SUPPLIER-01:OPEN`
