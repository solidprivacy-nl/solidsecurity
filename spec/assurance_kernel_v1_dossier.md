...
- `REQ-ACCESS-LIFECYCLE`: `SRC-SYNTH-ACCESS -> REQ-ACCESS-LIFECYCLE -> SS-ACCESS-002 -> IMP-ACCESS -> EVID-ACCESS-RECERT,EVID-GOV-REVIEW -> ASM-ACCESS -> RESULT=SATISFACTORY -> REV-ACCESS -> DEC-ACCESS -> VERIFIED`
- `REQ-ACCESS-LIFECYCLE`: `SRC-SYNTH-ACCESS -> REQ-ACCESS-LIFECYCLE -> SS-SUP-002 -> IMP-SUPPLIER -> EVID-GOV-REVIEW -> ASM-ACCESS-SUPPLIER -> RESULT=SATISFACTORY -> REV-ACCESS-SUPPLIER -> DEC-ACCESS-SUPPLIER -> VERIFIED`
- `REQ-ORPHAN-MONITORING`: `SRC-SYNTH-SUPPLIER -> REQ-ORPHAN-MONITORING -> GAP(no control mapping)`
- `REQ-RECOVERY-TEST`: `SRC-SYNTH-RESILIENCE -> REQ-RECOVERY-TEST -> SS-RES-001 -> IMP-RECOVERY -> EVID-RECOVERY-OLD -> ASM-RECOVERY -> RESULT=PARTIAL -> REOPENED`
- `REQ-SUPPLIER-GOV`: `SRC-SYNTH-SUPPLIER -> REQ-SUPPLIER-GOV -> SS-SUP-002 -> IMP-SUPPLIER -> EVID-GOV-REVIEW,EVID-SUPPLIER-ATTESTATION -> ASM-SUPPLIER -> RESULT=PARTIAL -> CONFLICT-SUPPLIER-01:OPEN`
