...
- `REQ-ACCESS-LIFECYCLE -> SS-ACCESS-002 -> IMP-ACCESS -> [EVID-ACCESS-RECERT,EVID-GOV-REVIEW] -> ASM-ACCESS[result=SATISFACTORY,proposal=EVIDENCED] -> REV-ACCESS[R2] -> VERIFIED`
- `REQ-ACCESS-LIFECYCLE -> SS-SUP-002 -> IMP-SUPPLIER -> [EVID-GOV-REVIEW] -> ASM-ACCESS-SUPPLIER[result=SATISFACTORY,proposal=EVIDENCED] -> REV-ACCESS-SUPPLIER[R2] -> VERIFIED`
- `REQ-RECOVERY-TEST -> SS-RES-001 -> IMP-RECOVERY -> [EVID-RECOVERY-FRESH] -> ASM-RECOVERY-V2[result=SATISFACTORY,proposal=EVIDENCED] -> REV-RECOVERY-V2[R2] -> VERIFIED`
