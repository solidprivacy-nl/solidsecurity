...
Project/change review follows the current central Control authority and preserves exact candidate/head/base binding plus fresh review after candidate movement; this strategy does not encode a fixed worker lane or role topology.
